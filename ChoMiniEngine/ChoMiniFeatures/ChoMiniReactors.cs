...
namespace Yoru.ChoMiniEngine
{
    ...
    {
        private readonly List<(IChoMiniNodeAction effect, float duration)> _entries
            = new List<(IChoMiniNodeAction effect, float duration)>();
        ...
        public void Register(IChoMiniNodeAction effect, float duration)
        {
        ...
        private async UniTask RunSingleLoop(IChoMiniNodeAction effect, float duration, CancellationToken token)
        {
            try
            {
